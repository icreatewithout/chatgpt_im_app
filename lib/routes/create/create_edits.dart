...
class CreateEdits extends StatefulWidget {
  static const String path = "/create/edits";

  const CreateEdits({super.key});

  @override
  State<CreateEdits> createState() => _CreateEditsState();
}

class _CreateEditsState extends State<CreateEdits> {
